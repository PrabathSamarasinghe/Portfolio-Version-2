          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 p-4 rounded-xl bg-surface border border-theme">
                ...
                <div>
                  <p className="text-xs text-secondary">Timezone</p>
            ...
            <div className="flex gap-3">
              <a href={personalInfo.github} target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg border border-theme text-secondary hover:text-accent hover:border-accent transition-all" aria-label="GitHub">
                <Github size={20} />
              </a>
              <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg border border-theme text-secondary hover:text-accent hover:border-accent transition-all" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              <a href={personalInfo.twitter} target="_blank" rel="noopener noreferrer" className="p-3 rounded-lg border border-theme text-secondary hover:text-accent hover:border-accent transition-all" aria-label="Twitter">
                <Twitter size={20} />
              </a>
            </div>
          </div>
          ...
          <div className="glass-card p-8">
            {submitted ? (
              <div className="flex flex-col items-center justify-center h-full py-12 text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-highlight">Message Sent!</h3>
